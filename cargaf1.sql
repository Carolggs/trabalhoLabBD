...
\copy stg_circuits              FROM '/home/carolina/Downloads/LabBD/circuits.csv'                 WITH (FORMAT csv, HEADER true, ENCODING 'LATIN1')
\copy stg_constructors          FROM '/home/carolina/Downloads/LabBD/constructors.csv'             WITH (FORMAT csv, HEADER true)
\copy stg_drivers               FROM '/home/carolina/Downloads/LabBD/drivers.csv'                  WITH (FORMAT csv, HEADER true)
\copy stg_races                 FROM '/home/carolina/Downloads/LabBD/races.csv'                    WITH (FORMAT csv, HEADER true)
\copy stg_driver_standings      (season, round, driver_id, position, points, wins)      FROM '/home/carolina/Downloads/LabBD/driver_standings.csv'      WITH (FORMAT csv, HEADER true)
\copy stg_constructor_standings (season, round, constructor_id, position, points, wins) FROM '/home/carolina/Downloads/LabBD/constructor_standings.csv' WITH (FORMAT csv, HEADER true)
\copy stg_results               FROM '/home/carolina/Downloads/LabBD/results.csv'                  WITH (FORMAT csv, HEADER true)
\copy stg_qualifying            FROM '/home/carolina/Downloads/LabBD/qualifying.csv'               WITH (FORMAT csv, HEADER true)

-- Carregar dados geográficos complementares para staging
\copy stg_airports              FROM '/home/carolina/Downloads/LabBD/airports.csv'                 WITH (FORMAT csv, HEADER true)
\copy stg_countries             FROM '/home/carolina/Downloads/LabBD/countries.csv'                WITH (FORMAT csv, HEADER true)
\copy stg_time_zones            FROM '/home/carolina/Downloads/LabBD/timeZones.tsv'                WITH (FORMAT csv, HEADER true, DELIMITER E'\t')
\copy stg_feature_codes         FROM '/home/carolina/Downloads/LabBD/featureCodes_en.tsv'          WITH (FORMAT csv, HEADER false, DELIMITER E'\t')
\copy stg_iso_language_codes    FROM '//home/carolina/Downloads/LabBD/iso-languagecodes.tsv'        WITH (FORMAT csv, HEADER true, DELIMITER E'\t')
\copy stg_cities                FROM '/home/carolina/Downloads/LabBD/cities.tsv'                   WITH (FORMAT csv, HEADER false, DELIMITER E'\t')
-- ============================================================================================================
